<!-- Traitement de : ajouter une nouvelle entrée -->
<?php
	if(isset($_POST) && !empty($_POST['nom']) && !empty($_POST['prénom']) && !empty($_POST['numéro'])) 
	{
		...
		mysql_query("INSERT INTO annuaire VALUES('" . $_POST['nom'] . "', '" . $_POST['prénom'] . "', '" . $_POST['numéro'] . "')");
...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <body> 
	    <h4 class='objet'>Ajouter une entr&eacute;e</h4>
			<?php
					
				echo "<center><strong>Ajout de r&eacute;alis&eacute; avec succ&egrave;s</strong></center>";
		?>
		<br/>
    ...
    <body> 
	    <h4 class='objet'>Ajouter une entr&eacute;e</h4>
			<form action="#" method='post'>
				...
				<tr>
					<td><b>Num&eacute;ro de poste</b> </td>
					<td><input type="text" name="numéro" maxlength="250"></td>
				</tr>
				<tr>
