...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    ...
    <body>  
		<h4 class="objet">Ouvrir une session</h4> 
	      		...
	      		<fieldset style="text-align:center;">
	          		...
	          		<legend>Enregistrement</legend>
						...
						<label for="prenom">Pr&eacute;nom</label>
							...
							<input  type="text" name="prenom" id="prenom" value="" size="20" maxlength="20" />
					 ...
					 <p id="button">
							...
							<input style="margin-left: 20px;" type="reset" value="Annuler" />
					</p>
			</form> 
